import config
tee = config.Tee('../Results/%s/GNB_Regroup_%s%s_model.txt' % (config.args.dataset, config.args.tf_idf, config.args.remove_non), 'w')
...
print("Defining and doing a Gaussian Naive Bayes classifier for New-idea vs rest")
